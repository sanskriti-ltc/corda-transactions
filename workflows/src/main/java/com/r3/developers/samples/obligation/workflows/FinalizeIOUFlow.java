...
public class IOUContract implements Contract {
    ...
    public void verify(UtxoLedgerTransaction transaction) {
        ...
        requireThat(!output.getIssuerRole().isEmpty(), "The issuer role must not be empty.");
        
        // Commenting out fields that can be null
        // requireThat(output.getDrawee() != null && !output.getDrawee().getOrganisation().isEmpty(), "The drawee must not be empty.");
        // requireThat(output.getDrawer() != null && !output.getDrawer().getOrganisation().isEmpty(), "The drawer must not be empty.");
        // requireThat(output.getPayee() != null && !output.getPayee().getOrganisation().isEmpty(), "The payee must not be empty.");
        // requireThat(output.getPayer() != null && !output.getPayer().getOrganisation().isEmpty(), "The payer must not be empty.");
